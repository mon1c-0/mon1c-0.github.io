...
<?php
	...
	$articles = mysqli_query($connection, "SELECT * FROM `article` ORDER BY `id` DESC LIMIT $from, $notesonpage");
...
?>
	<a class="pagination__previous pagination__arrow" href="?page=">&#8592;</a>

	<a class="pagination__fastlink paghref" href="?page=<?php echo $pagin1; ?>"><?php echo $pagin1; ?></a>
	<a class="pagination__fastlink paghref" href="?page=<?php echo $pagin2; ?>"><?php echo $pagin2; ?></a>
	<a class="pagination__fastlink paghref" href="?page=<?php echo $pagin3; ?>"><?php echo $pagin3; ?></a>
	<a class="pagination__fastlink paghref" href="?page=<?php echo $pagin4; ?>"><?php echo $pagin4; ?></a>
	<a class="pagination__fastlink paghref" href="?page=<?php echo $pagin5; ?>"><?php echo $pagin5; ?></a>
